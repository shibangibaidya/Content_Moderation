# -*- coding: utf-8 -*-
"""Violent_Content_Detection_first3_frames.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1XCH1CrKckwXa0HC5cAxlJmAJlmXGQKQh
"""
...
"""Experimenting with the first 3 frames"""

def extract_first_three_frames(video_root_dir, output_root_dir):
    for label_folder in ["Violence", "NonViolence"]:
        ...
        for filename in os.listdir(input_folder):
            if filename.lower().endswith((".avi", ".mp4")):
                ...
                for i in range(3):  # Grab first three frames
                    ret, frame = cap.read()
                    if ret:
...
extract_first_three_frames(video_dir,output_dir)
