# -*- coding: utf-8 -*-
"""Violent_Content_Detection_first2frames.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Fnx5MlY2SbIMollTQzhv2HU0MeepsVMw
"""
...
"""Experimenting with the first 2 frames"""

def extract_first_two_frames(video_root_dir, output_root_dir):
    for label_folder in ["Violence", "NonViolence"]:
        ...
        for filename in os.listdir(input_folder):
            if filename.lower().endswith((".avi", ".mp4")):
                ...
                for i in range(2):  # Grab first two frames
                    ret, frame = cap.read()
                    if ret:
...
extract_first_two_frames(video_dir,output_dir)
...
# Loop through each video and run inference on first 2 frames
...
"""Inference time distribution graph"""
...
"""Frames Processed Distribution Graph"""
...
"""Video Duration Distribution Graph"""
