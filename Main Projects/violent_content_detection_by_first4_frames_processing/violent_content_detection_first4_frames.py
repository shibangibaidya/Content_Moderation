# -*- coding: utf-8 -*-
"""Violent_Content_Detection_first4_frames.ipynb
...
def extract_first_four_frames(video_root_dir, output_root_dir):
    for label_folder in ["Violence", "NonViolence"]:
        ...
        for filename in os.listdir(input_folder):
            if filename.lower().endswith((".avi", ".mp4")):
                ...
                for i in range(4):  # Grab first four frames
                    ret, frame = cap.read()
                    if ret:
...
extract_first_four_frames(video_dir,output_dir)
...
# Loop through each video and run inference on first 4 frames
